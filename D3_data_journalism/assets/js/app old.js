...
d3.csv("assets/data/data.csv").then(function(stateData) {
    ...
    var textCircle = chartGroup.selectAll("textCircle")
    .data(stateData)
    .enter()
    .append("text")
    ...
    // Create axes labels
    var axisText = chartGroup.append("text")
    ...
    // Hide the circles if y-label is clicked
    ...
    var toolTip = d3.tip()
      .attr("class", "tooltip")
      .offset([80, -60])
      .html(d => `${d.healthcare}<br>${d.poverty}`);
